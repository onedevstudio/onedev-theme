...
function odin_enqueue_scripts() {
  ...
  if ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) {
    ...
    wp_enqueue_style( 'odin-main-style', $template_url . '/assets/stylesheets/main.css' );

    // Loads main script file.
    wp_enqueue_script( 'odin-main-script', $template_url . '/assets/javascripts/main.js', array(), null, true );
    ...
    wp_enqueue_script( 'odin-main-script', $template_url . '/assets/javascripts/main.min.js', array(), null, true );
  }
